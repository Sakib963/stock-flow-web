                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            {
                                path: 'brand-list',
                                loadComponent: () => import('./pages/configuration/brands/display-brand-list/display-brand-list.component').then((m) => m.DisplayBrandListComponent),
                            },
                            {
                                path: 'create-brand',
                                loadComponent: () => import('./pages/configuration/brands/create-brand/create-brand.component').then((m) => m.CreateBrandComponent),
                            },
                            {
                                path: 'view-brand/:oid',
                                loadComponent: () => import('./pages/configuration/brands/view-brand-details/view-brand-details.component').then((m) => m.ViewBrandDetailsComponent),
                            },
                        ],
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                path: 'supplier-list',
                                loadComponent: () => import('./pages/configuration/supplier/display-supplier-list/display-supplier-list.component').then((m) => m.DisplaySupplierListComponent),
                            },
                            {
                                path: 'create-supplier',
                                loadComponent: () => import('./pages/configuration/supplier/create-supplier/create-supplier.component').then((m) => m.CreateSupplierComponent),
                            },
                            {
                                path: 'view-supplier/:oid',
                                loadComponent: () => import('./pages/configuration/supplier/view-supplier-details/view-supplier-details.component').then((m) => m.ViewSupplierDetailsComponent),
                            },
                        ],
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                path: 'product-list',
                                loadComponent: () => import('./pages/configuration/product/display-product-list/display-product-list.component').then((m) => m.DisplayProductListComponent),
                            },
                            {
                                path: 'create-product',
                                loadComponent: () => import('./pages/configuration/product/create-product/create-product.component').then((m) => m.CreateProductComponent),
                            },
                            {
                                path: 'view-product/:oid',
                                loadComponent: () => import('./pages/configuration/product/view-product-details/view-product-details.component').then((m) => m.ViewProductDetailsComponent),
                            },
                        ],
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                path: 'warehouse-list',
                                loadComponent: () => import('./pages/configuration/warehouse/display-warehouse-list/display-warehouse-list.component').then((m) => m.DisplayWarehouseListComponent),
                            },
                            {
                                path: 'create-warehouse',
                                loadComponent: () => import('./pages/configuration/warehouse/create-warehouse/create-warehouse.component').then((m) => m.CreateWarehouseComponent),
                            },
                            {
                                path: 'view-warehouse/:oid',
                                loadComponent: () => import('./pages/configuration/warehouse/view-warehouse-details/view-warehouse-details.component').then((m) => m.ViewWarehouseDetailsComponent),
                            },
                        ],
                    },
                ],
