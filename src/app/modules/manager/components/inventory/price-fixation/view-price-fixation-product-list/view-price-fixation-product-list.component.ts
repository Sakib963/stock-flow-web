...
@Component({
  selector: 'app-view-price-fixation-product-list',
  standalone: true,
  imports: [CommonModule, NgZorroCustomModule, LoaderComponent],
  templateUrl: './view-price-fixation-product-list.component.html',
  styleUrls: ['./view-price-fixation-product-list.component.scss'],
})
export class ViewPriceFixationProductListComponent {
  @Input() data: any[] = [];
