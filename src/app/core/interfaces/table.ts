...
export interface TableColumn {
    ...
    column_type?: 'text' | 'long-text' | 'number' | 'date' | 'boolean' | 'status' | 'action' | 'currency'; // Data type
    currency?: string; // Currency code (e.g., 'USD', 'BDT') if column_type is 'currency'
    locale?: string; // Locale for number/currency formatting (e.g., 'en-US', 'en-IN')
