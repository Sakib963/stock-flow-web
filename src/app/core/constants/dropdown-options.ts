export const DROPDOWN_OPTIONS = {
  ...
  DISPOSAL_REASONS: [
    ...
    { label: 'Spoiled / Perished', value: 'spoiled' },
    { label: 'Breakage', value: 'breakage' },
    { label: 'Theft / Loss / Shrinkage', value: 'theft_loss' },
    { label: 'Quality Reject', value: 'quality_reject' },
    { label: 'Opened / Sample', value: 'opened' },
    { label: 'Customer Return - Unsellable', value: 'return_unsellable' },
    { label: 'Obsolete', value: 'obsolete' },
    { label: 'Other', value: 'other' },
  ],
  DISPOSAL_METHODS: [
    { label: 'Discard / Trash', value: 'discard' },
